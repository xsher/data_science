        ...
        if detected is None:
            ...
            if show_backproj:
                ...
                if hw > 0 and hh > 0:
                    ...
                    if ch == ord('o'):
                        cv.imwrite('O_16x16_{}.jpg'.format(ts), hand_img_16)
                        cv.imwrite('O_224x224_{}.jpg'.format(ts), hand_img_224)

                    if ch == ord('c'):
                        cv.imwrite('C_16x16_{}.jpg'.format(ts), hand_img_16)
                        cv.imwrite('C_224x224_{}.jpg'.format(ts), hand_img_224)
            try:
